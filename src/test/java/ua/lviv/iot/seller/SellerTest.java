...
public class SellerTest {
	...
	public void testFirstCaseHamsters() {
		...
		Seller seller = new Seller(firstCaseHamsters, 150);
	...
	public void testSecondCaseHamsters() {
		...
		Seller seller = new Seller(secondCaseHamsters, 12);
		int result = seller.findMaxNumberOfHamsters();
	...
	public void testThirdCaseHamsters() {
		...
		Seller seller = new Seller(firstCaseHamsters, 7);
		int result = seller.findMaxNumberOfHamsters();
		assertEquals(2, result);
	}
	@Test
	public void testForthCaseHamsters() {
		...
		Seller seller = new Seller(forthCaseHamsters, 19);
		int result = seller.findMaxNumberOfHamsters();
		assertEquals(3, result);
	}
	@Test
	public void testFifthCaseHamsters() {
		...
		Seller seller = new Seller(fifthCaseHamsters, 2);
		int result = seller.findMaxNumberOfHamsters();
	...
	@Test
	  public void testSixthCaseHamsters() {
	    ...
	    Seller seller = new Seller(sixthCaseHamsters, 12);
	    int result = seller.findMaxNumberOfHamsters();
	    assertEquals(2, result);
	  }
	@Test
	  public void testSeventhCaseHamsters() {
	    ...
	    Seller seller = new Seller(seventhCaseHamsters, 50);
	    int result = seller.findMaxNumberOfHamsters();
	    assertEquals(1, result);
	  }
	@Test
	  public void testEighthCaseHamsters() {
	    ...
	    Seller seller = new Seller(eighthCaseHamsters, 100);
	    int result = seller.findMaxNumberOfHamsters();
	    assertEquals(1, result);
	  }
	@Test
	  public void testNinthCaseHamsters() {
	    ...
	    Seller seller = new Seller(ninthCaseHamsters, 202);
	    int result = seller.findMaxNumberOfHamsters();
	    assertEquals(2, result);
	  }
	@Test
	  public void testTenthCaseHamsters() {
	    ...
	    Seller seller = new Seller(tenthCaseHamsters, 3);
	    int result = seller.findMaxNumberOfHamsters();
	    assertEquals(3, result);
	  }
}
